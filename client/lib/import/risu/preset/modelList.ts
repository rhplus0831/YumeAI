// This code is copy of code from RisuAI(https://github.com/kwaroran/RisuAI/blob/main/src/ts/model/ooba.ts)
...
export function getLLMByModal(id: string | undefined): string {
    const model = LLMModels.find(model => model.id === id);

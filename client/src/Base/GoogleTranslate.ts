...
// Modifications Made by RH+ on 2024-12-07 for Change to fit with YumeAI

import {UseSendingAlertProps} from "./SendingAlert/useSendingAlert.ts";

export async function googleTranslate(text: string, props: UseSendingAlertProps, streamingReceiver?: (data: unknown) => void) {
